...
<head>
    <meta charset="UTF-8">
    <meta name="keywords" content="PHP,История PHP,Где используется PHP,Использование PHP,Зачем нужен PHP" />
    <meta name="description" content="Что такое PHP,История языка PHP,Использование PHP" />
...
<div class="container">
    <div class="php">
        ...
        <p>
            <strong>PHP</strong>-Скриптовый язык общего назначения, 
        ...
        <img class="php_img" src="./img/luchshie-kursy-po-php.jpg">
	<h3>
       История языка
    </h3>
		<p>	
            Изначально PHP расшифровывался как 
			...
			в двух режимах: писать код прямо в коде страницы или выносить всё в отдельные файлы.
        </p>
	
	<h3>
        <strong>Зачем нужен PHP</strong>
    </h3>
		<p>
	...
	<h3>
        <strong>Где используется PHP</strong>
    </h3>
		<p>
	...
	<h3>
        <strong>Использование PHP</strong>
    </h3>
	...
	<h4>
        <strong>Где скачать PHP?</strong>
    </h4>
		<p>
            Мы рекомендуем использовать программную сборку OpenServer. 
            После загрузки и установки на вашем компьютере появятся свежая
             версия PHP, веб-сервер, база данных, и много других программ и 
             инструментов для удобной работы. Подробнее об установке и использовании 
             мы рассказываем на первой лекции.
        </p>
		
	<h4>
        <strong>Как выглядит PHP-сценарий</strong>
    </h4>
	
		<p>
            Типичный PHP-сценарий — это набор выражений. Каждое выражение начинается 
            с новой строчки и заканчивается точкой с запятой.<br><br>

			Выражение — это инструкция, которая приказывает PHP-интерпретатору 
            выполнить одно действие, например, сложить два числа или вывести на 
            экран информацию. Давайте посмотрим на самый простой сценарий.
             Он будет выводить на экран одну строку: «Привет, Мир!»:
        </p>
	...
	<img src="./img/634124.png">	
		<p>
            Обратите внимание, что в этом примере мы использовали дополнительный фрагмент — ?>. 
            С его помощью мы сообщаем серверу, где заканчивается наш PHP-сценарий. В случае, 
            если наш код последний в документе, и после него ничего не следует, этот фрагмент
            не обязателен.
        </p>
	<h3>
		...
		<p>
            По старой памяти, когда ужасного 
